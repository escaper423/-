...
$sql = "select 교과목.년도, 교과목.교과목명, 수강.분반, 수강.성적 from 교과목,수강 where 교과목.교과목번호 = 수강.교과목번호 and 교과목.분반 = 수강.분반 and 수강.학번 = '$stu_num'";
$result = oci_parse($conn,$sql);
$res = oci_execute($result);

echo "<table border=1 border color='#aaaaaa' align='center'>";
echo "<center><h1>성적 조회</h1></center><br><right>학번 : $stu_num </right><br>";
