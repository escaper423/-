...
<?
/* 시간표 변수들을 받아온다. */
$sql11 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '1'";
$result11 = oci_parse($conn,$sql11);
$res11 = oci_execute($result11);
$row11 = oci_fetch_array($result11, OCI_ASSOC);

$sql12 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '2'";
$result12 = oci_parse($conn,$sql12);
$res12 = oci_execute($result12);
$row12 = oci_fetch_array($result12, OCI_ASSOC);

$sql13 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '3'";
$result13 = oci_parse($conn,$sql13);
$res13 = oci_execute($result13);
$row13 = oci_fetch_array($result13, OCI_ASSOC);

$sql14 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '4'";
$result14 = oci_parse($conn,$sql14);
$res14 = oci_execute($result14);
$row14 = oci_fetch_array($result14, OCI_ASSOC);

$sql15 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '5'";
$result15 = oci_parse($conn,$sql15);
$res15 = oci_execute($result15);
$row15 = oci_fetch_array($result15, OCI_ASSOC);

$sql16 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '6'";
$result16 = oci_parse($conn,$sql16);
$res16 = oci_execute($result16);
$row16 = oci_fetch_array($result16, OCI_ASSOC);

$sql17 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '7'";
$result17 = oci_parse($conn,$sql17);
$res17 = oci_execute($result17);
$row17 = oci_fetch_array($result17, OCI_ASSOC);

$sql18 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '8'";
$result18 = oci_parse($conn,$sql18);
$res18 = oci_execute($result18);
$row18 = oci_fetch_array($result18, OCI_ASSOC);

$sql19 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '월' and 교수시간표.시간 = '9'";
$result19 = oci_parse($conn,$sql19);
$res19 = oci_execute($result19);
$row19 = oci_fetch_array($result19, OCI_ASSOC);

$sql21 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '1'";
$result21 = oci_parse($conn,$sql21);
$res21 = oci_execute($result21);
$row21 = oci_fetch_array($result21, OCI_ASSOC);

$sql22 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '2'";
$result22 = oci_parse($conn,$sql22);
$res22 = oci_execute($result22);
$row22 = oci_fetch_array($result22, OCI_ASSOC);

$sql23 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '3'";
$result23 = oci_parse($conn,$sql23);
$res23 = oci_execute($result23);
$row23 = oci_fetch_array($result23, OCI_ASSOC);

$sql24 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '4'";
$result24 = oci_parse($conn,$sql24);
$res24 = oci_execute($result24);
$row24 = oci_fetch_array($result24, OCI_ASSOC);

$sql25 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '5'";
$result25 = oci_parse($conn,$sql25);
$res25 = oci_execute($result25);
$row25 = oci_fetch_array($result25, OCI_ASSOC);

$sql26 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '6'";
$result26 = oci_parse($conn,$sql26);
$res26 = oci_execute($result26);
$row26 = oci_fetch_array($result26, OCI_ASSOC);

$sql27 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '7'";
$result27 = oci_parse($conn,$sql27);
$res27 = oci_execute($result27);
$row27 = oci_fetch_array($result27, OCI_ASSOC);

$sql28 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '8'";
$result28 = oci_parse($conn,$sql28);
$res28 = oci_execute($result28);
$row28 = oci_fetch_array($result28, OCI_ASSOC);

$sql29 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '화' and 교수시간표.시간 = '9'";
$result29 = oci_parse($conn,$sql29);
$res29 = oci_execute($result29);
$row29 = oci_fetch_array($result29, OCI_ASSOC);

$sql31 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '1'";
$result31 = oci_parse($conn,$sql31);
$res31 = oci_execute($result31);
$row31 = oci_fetch_array($result31, OCI_ASSOC);

$sql32 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '2'";
$result32 = oci_parse($conn,$sql32);
$res32 = oci_execute($result32);
$row32 = oci_fetch_array($result32, OCI_ASSOC);

$sql33 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '3'";
$result33 = oci_parse($conn,$sql33);
$res33 = oci_execute($result33);
$row33 = oci_fetch_array($result33, OCI_ASSOC);

$sql34 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '4'";
$result34 = oci_parse($conn,$sql34);
$res34 = oci_execute($result34);
$row34 = oci_fetch_array($result34, OCI_ASSOC);

$sql35 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '5'";
$result35 = oci_parse($conn,$sql35);
$res35 = oci_execute($result35);
$row35 = oci_fetch_array($result35, OCI_ASSOC);

$sql36 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '6'";
$result36 = oci_parse($conn,$sql36);
$res36 = oci_execute($result36);
$row36 = oci_fetch_array($result36, OCI_ASSOC);

$sql37 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '7'";
$result37 = oci_parse($conn,$sql37);
$res37 = oci_execute($result37);
$row37 = oci_fetch_array($result37, OCI_ASSOC);

$sql38 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '8'";
$result38 = oci_parse($conn,$sql38);
$res38 = oci_execute($result38);
$row38 = oci_fetch_array($result38, OCI_ASSOC);

$sql39 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '수' and 교수시간표.시간 = '9'";
$result39 = oci_parse($conn,$sql39);
$res39 = oci_execute($result39);
$row39 = oci_fetch_array($result39, OCI_ASSOC);

$sql41 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '1'";
$result41 = oci_parse($conn,$sql41);
$res41 = oci_execute($result41);
$row41 = oci_fetch_array($result41, OCI_ASSOC);

$sql42 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '2'";
$result42 = oci_parse($conn,$sql42);
$res42 = oci_execute($result42);
$row42 = oci_fetch_array($result42, OCI_ASSOC);

$sql43 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '3'";
$result43 = oci_parse($conn,$sql43);
$res43 = oci_execute($result43);

$sql44 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '4'";
$result44 = oci_parse($conn,$sql44);
$res44 = oci_execute($result44);
$row44 = oci_fetch_array($result44, OCI_ASSOC);

$sql45 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '5'";
$result45 = oci_parse($conn,$sql45);
$res45 = oci_execute($result45);
$row45 = oci_fetch_array($result45, OCI_ASSOC);

$sql46 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '6'";
$result46 = oci_parse($conn,$sql46);
$res46 = oci_execute($result46);
$row46 = oci_fetch_array($result46, OCI_ASSOC);

$sql47 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '7'";
$result47 = oci_parse($conn,$sql47);
$res47 = oci_execute($result47);
$row47 = oci_fetch_array($result47, OCI_ASSOC);

$sql48 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '8'";
$result48 = oci_parse($conn,$sql48);
$res48 = oci_execute($result48);
$row48 = oci_fetch_array($result48, OCI_ASSOC);

$sql49 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '목' and 교수시간표.시간 = '9'";
$result49 = oci_parse($conn,$sql49);
$res49 = oci_execute($result49);
$row49 = oci_fetch_array($result49, OCI_ASSOC);

$sql51 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '1'";
$result51 = oci_parse($conn,$sql51);
$res51 = oci_execute($result51);
$row51 = oci_fetch_array($result51, OCI_ASSOC);

$sql52 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '2'";
$result52 = oci_parse($conn,$sql52);
$res52 = oci_execute($result52);
$row52 = oci_fetch_array($result52, OCI_ASSOC);

$sql53 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '3'";
$result53 = oci_parse($conn,$sql53);
$res53 = oci_execute($result53);
$row53 = oci_fetch_array($result53, OCI_ASSOC);

$sql54 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '4'";
$result54 = oci_parse($conn,$sql54);
$res54 = oci_execute($result54);
$row54 = oci_fetch_array($result54, OCI_ASSOC);

$sql55 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '5'";
$result55 = oci_parse($conn,$sql55);
$res55 = oci_execute($result55);
$row55 = oci_fetch_array($result55, OCI_ASSOC);

$sql56 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '6'";
$result56 = oci_parse($conn,$sql56);
$res56 = oci_execute($result56);
$row56 = oci_fetch_array($result56, OCI_ASSOC);

$sql57 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '7'";
$result57= oci_parse($conn,$sql57);
$res57 = oci_execute($result57);
$row57 = oci_fetch_array($result57, OCI_ASSOC);

$sql58 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '8'";
$result58 = oci_parse($conn,$sql58);
$res58 = oci_execute($result58);
$row58 = oci_fetch_array($result58, OCI_ASSOC);

$sql59 = "select 교과목.교과목명,교과목.교수이름,교수시간표.교과목번호,교수시간표.분반 from 교수시간표,교과목 where 교수시간표.교과목번호 = 교과목.교과목번호 and 교수시간표.교수번호 = '$pf_num' and 교수시간표.요일 = '금' and 교수시간표.시간 = '9'";
